...
const Home = () => {
  ...
  return (
    <Container>
      ...
      <Header as='h1' style={{ fontSize: 'min(20vw, 300px)', fontFamily: "Billabong", color: "#85e2ff" }} textAlign="center">
                filters
            </Header>
      </Segment>
        ...
        <Grid container stackable verticalAlign='middle'>
          <Grid.Row>
            ...
            <Grid.Column floated='right' width={6}>
              <Image bordered rounded size='large' src='https://media.istockphoto.com/photos/banana-picture-id1184345169?k=6&m=1184345169&s=612x612&w=0&h=I159iiNId_-XwGsoZlpi9WyeACv8kpg-EmyB5X2oo30=' />
            </Grid.Column>
          </Grid.Row>
          <Grid.Row>
